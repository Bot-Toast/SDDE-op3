...
public class DecryptScene {
    ...
    public static void decryptScene(Stage window, Scene menu){
        ...
        fileOpen.setOnAction(e -> {
            File fileToDecrypt = GuiUtility.fileChoice(window);
        ...
        prvKey.setOnAction(e -> {
            File prvKeyFile = GuiUtility.fileChoice(window);
            if (prvKeyFile != null) {
                saveText.clear();
        ...
        deCrypt.getStylesheets().add("DarkMode.css");
        ...
        deCrypt2.getStylesheets().add("DarkMode.css");
