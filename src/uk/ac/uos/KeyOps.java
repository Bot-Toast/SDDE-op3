...
public class KeyOps {
    ...
    private static final File pvKeyLoc = (new File(System.getProperty("user.home"), ".\\Roaming\\private"));

    //Method to generate Crypto values - path is passed in to save in the location user wants, PrvKey path will be hardcoded.
    public void RSAKeyGen(String path1) throws IOException {
        ...
        File pbKeyLoc = new File(path1);
        FileOps.writeKeysToFile(pbKeyLoc, pKey, modulus);
